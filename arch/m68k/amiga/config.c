...
static char s_unknown8[] __initdata = "unknown8";
static char *amiga_models[] __initdata = {
	...
	[AMI_unknown8-AMI_500]	= s_unknown8,
};
...
static void __init amiga_identify(void)
{
	...
	if (amiga_model >= AMI_500 && amiga_model <= AMI_unknown8) {
	...
	case AMI_unknown8:
		panic("No support for unknown8 yet");
