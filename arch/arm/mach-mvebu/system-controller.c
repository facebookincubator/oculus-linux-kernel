...
static const struct mvebu_system_controller unknown5_system_controller = {
...
static const struct of_device_id of_system_controller_table[] = {
	{
		.compatible = "marvell,unknown5-system-controller",
		.data = (void *) &unknown5_system_controller,
	}, {
