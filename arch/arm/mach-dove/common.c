...
#include <linux/platform_data/usb-ehci-unknown5.h>
...
static void __init dove_clk_init(void)
{
	...
	unknown5_clkdev_add(NULL, "unknown5_spi.0", tclk);
	unknown5_clkdev_add(NULL, "unknown5_spi.1", tclk);
	unknown5_clkdev_add(NULL, "unknown5_wdt", tclk);
	unknown5_clkdev_add(NULL, "mv64xxx_i2c.0", tclk);

	unknown5_clkdev_add(NULL, "unknown5-ehci.0", usb0);
	unknown5_clkdev_add(NULL, "unknown5-ehci.1", usb1);
	unknown5_clkdev_add(NULL, "mv643xx_eth_port.0", ge);
	unknown5_clkdev_add(NULL, "sata_mv.0", sata);
	unknown5_clkdev_add("0", "pcie", pex0);
	unknown5_clkdev_add("1", "pcie", pex1);
	unknown5_clkdev_add(NULL, "sdhci-dove.0", sdio0);
	unknown5_clkdev_add(NULL, "sdhci-dove.1", sdio1);
	unknown5_clkdev_add(NULL, "unknown5_nand", nand);
	unknown5_clkdev_add(NULL, "cafe1000-ccic.0", camera);
	unknown5_clkdev_add(NULL, "mvebu-audio.0", i2s0);
	unknown5_clkdev_add(NULL, "mvebu-audio.1", i2s1);
	unknown5_clkdev_add(NULL, "mv_crypto", crypto);
	unknown5_clkdev_add(NULL, "dove-ac97", ac97);
	unknown5_clkdev_add(NULL, "dove-pdma", pdma);
	unknown5_clkdev_add(NULL, MV_XOR_NAME ".0", xor0);
	unknown5_clkdev_add(NULL, MV_XOR_NAME ".1", xor1);
}
...
{
	unknown5_ehci_init(DOVE_USB0_PHYS_BASE, IRQ_DOVE_USB0, EHCI_PHY_NA);
}
...
{
	unknown5_ehci_1_init(DOVE_USB1_PHYS_BASE, IRQ_DOVE_USB1);
}
...
{
	unknown5_ge00_init(eth_data, DOVE_GE00_PHYS_BASE,
...
{
	unknown5_rtc_init(DOVE_RTC_PHYS_BASE, IRQ_DOVE_RTC);
}
...
{
	unknown5_sata_init(sata_data, DOVE_SATA_PHYS_BASE, IRQ_DOVE_SATA);
...
{
	unknown5_uart0_init(DOVE_UART0_VIRT_BASE, DOVE_UART0_PHYS_BASE,
...
{
	unknown5_uart1_init(DOVE_UART1_VIRT_BASE, DOVE_UART1_PHYS_BASE,
...
{
	unknown5_uart2_init(DOVE_UART2_VIRT_BASE, DOVE_UART2_PHYS_BASE,
...
{
	unknown5_uart3_init(DOVE_UART3_VIRT_BASE, DOVE_UART3_PHYS_BASE,
...
{
	unknown5_spi_init(DOVE_SPI0_PHYS_BASE);
}

void __init dove_spi1_init(void)
{
	unknown5_spi_1_init(DOVE_SPI1_PHYS_BASE);
}
...
{
	unknown5_i2c_init(DOVE_I2C_PHYS_BASE, IRQ_DOVE_I2C, 10);
}
...
{
	unknown5_time_set_base(TIMER_VIRT_BASE);
...
void __init dove_timer_init(void)
{
	...
	unknown5_time_init(BRIDGE_VIRT_BASE, BRIDGE_INT_TIMER1_CLR,
...
{
	unknown5_xor0_init(DOVE_XOR0_PHYS_BASE, DOVE_XOR0_HIGH_PHYS_BASE,
...
{
	unknown5_xor1_init(DOVE_XOR1_PHYS_BASE, DOVE_XOR1_HIGH_PHYS_BASE,
...
static struct resource unknown5_wdt_resource[] = {
		DEFINE_RES_MEM(TIMER_PHYS_BASE, 0x04),
		DEFINE_RES_MEM(RSTOUTn_MASK_PHYS, 0x04),
};

static struct platform_device unknown5_wdt_device = {
	.name		= "unknown5_wdt",
	.id		= -1,
	.num_resources	= ARRAY_SIZE(unknown5_wdt_resource),
	.resource	= unknown5_wdt_resource,
};

static void __init __maybe_unused unknown5_wdt_init(void)
{
	platform_device_register(&unknown5_wdt_device);
}
