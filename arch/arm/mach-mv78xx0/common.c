...
#include <linux/platform_data/mtd-unknown5_nand.h>
#include <plat/time.h>
...
{
	unknown5_ehci_init(USB0_PHYS_BASE, IRQ_MV78XX0_USB_0, EHCI_PHY_NA);
}
...
{
	unknown5_ehci_1_init(USB1_PHYS_BASE, IRQ_MV78XX0_USB_1);
}
...
{
	unknown5_ehci_2_init(USB2_PHYS_BASE, IRQ_MV78XX0_USB_2);
}
...
void __init mv78xx0_ge10_init(struct mv643xx_eth_platform_data *eth_data)
{
	...
	unknown5_ge10_init(eth_data, GE10_PHYS_BASE, IRQ_MV78XX0_GE10_SUM);
}
...
void __init mv78xx0_ge11_init(struct mv643xx_eth_platform_data *eth_data)
{
	...
	unknown5_ge11_init(eth_data, GE11_PHYS_BASE, IRQ_MV78XX0_GE11_SUM);
}
...
{
	unknown5_i2c_init(I2C_0_PHYS_BASE, IRQ_MV78XX0_I2C_0, 8);
	unknown5_i2c_1_init(I2C_1_PHYS_BASE, IRQ_MV78XX0_I2C_1, 8);
}
...
{
	unknown5_sata_init(sata_data, SATA_PHYS_BASE, IRQ_MV78XX0_SATA);
}
...
{
	unknown5_uart0_init(UART0_VIRT_BASE, UART0_PHYS_BASE,
...
{
	unknown5_uart1_init(UART1_VIRT_BASE, UART1_PHYS_BASE,
...
{
	unknown5_uart2_init(UART2_VIRT_BASE, UART2_PHYS_BASE,
...
{
	unknown5_uart3_init(UART3_VIRT_BASE, UART3_PHYS_BASE,
