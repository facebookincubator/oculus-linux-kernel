...
{
	unknown5_irq_init(0, IRQ_VIRT_BASE + IRQ_MASK_LOW_OFF);
	unknown5_irq_init(32, IRQ_VIRT_BASE + IRQ_MASK_HIGH_OFF);
	unknown5_irq_init(64, IRQ_VIRT_BASE + IRQ_MASK_ERR_OFF);
	 ...
	 * core #0.)
	 */
	unknown5_gpio_init(NULL, 0, 32, GPIO_VIRT_BASE,
