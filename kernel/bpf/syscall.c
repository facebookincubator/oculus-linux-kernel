...
// BPF_MAP_TYPE_PERCPU_CGROUP_STORAGE not backported yet
...
// BPF_MAP_TYPE_STRUCT_OPS not backported yet
...
*/
		...
		err = bpf_fd_reuseport_array_update_elem(map, key, value,
							 flags);
/* BPF_MAP_TYPE_[QUEUE|STACK] not backported yet
