...
unsigned int sysctl_sched_lb_rebalance_bg;
unsigned int sysctl_sched_adaptive_busy_factor;
...
struct ctl_table walt_table[] = {
	...
	{
		.procname	= "sched_lb_rebalance_bg",
		.data		= &sysctl_sched_lb_rebalance_bg,
		.maxlen		= sizeof(int),
		.mode		= 0644,
		.proc_handler	= proc_dointvec_minmax,
		.extra1		= SYSCTL_ZERO,
	...
	{
		.procname	= "sched_adaptive_busy_factor",
		.data		= &sysctl_sched_adaptive_busy_factor,
		.maxlen		= sizeof(int),
		.mode		= 0644,
		.proc_handler	= proc_dointvec_minmax,
		.extra1		= SYSCTL_ZERO,
