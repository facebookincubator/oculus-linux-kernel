...
static inline void __nocfi set_next_task(struct rq *rq, struct task_struct *next)
{
 ...
 */
static inline void __nocfi cpufreq_update_util(struct rq *rq, unsigned int flags)
{
