...
static struct ctl_table kern_table[] = {
	...
	{
		.procname	= "sched_rt_wakeup_on_idle",
		.data		= &sysctl_sched_rt_wakeup_on_idle,
		.maxlen		= sizeof(unsigned int),
		.mode		= 0644,
		.proc_handler	= proc_dointvec,
	},
	{
		.procname	= "sched_rt_preempt_lowest",
		.data		= &sysctl_sched_rt_preempt_lowest,
		.maxlen		= sizeof(unsigned int),
		.mode		= 0644,
		.proc_handler	= proc_dointvec,
	},
	...
	{
		.procname	= "sched_swqueue",
		.data           = &sysctl_sched_swqueue,
		.maxlen		= sizeof(unsigned int),
		.mode		= 0644,
		.proc_handler	= sysctl_swqueue_toggle,
	},
	{
		.procname       = "sched_swqueue_on_yield",
		.data           = &sysctl_sched_swqueue_on_yield,
		.maxlen         = sizeof(unsigned int),
		.mode           = 0644,
		.proc_handler   = proc_dointvec,
	},
