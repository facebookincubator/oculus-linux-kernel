...
static const struct hid_device_id hid_quirks[] = {
	...
	{ HID_USB_DEVICE(USB_VENDOR_ID_unknown6LORD, USB_DEVICE_ID_unknown6LORD_TWIN_USB_JOYSTICK), HID_QUIRK_MULTI_INPUT | HID_QUIRK_SKIP_OUTPUT_REPORTS },
...
#endif
#if IS_ENABLED(CONFIG_HID_unknown6LORD)
