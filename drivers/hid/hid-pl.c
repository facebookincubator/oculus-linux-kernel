...
/*
 *  Force feedback support for unknown6Lord/GreenAsia based devices
 *
 *  The devices are distributed under various names and the same USB device ID
 *  can be used in both adapters and actual game controllers.
 *
 *  0810:0001 "Twin USB Joystick"
 *   - tested with unknown6Lord USB/PS2 2in1 Adapter
...
static int plff_init(struct hid_device *hid)
{
	...
	*/
	...
	hid_info(hid, "Force feedback for unknown6Lord/GreenAsia devices by Anssi Hannula <anssi.hannula@gmail.com>\n");
