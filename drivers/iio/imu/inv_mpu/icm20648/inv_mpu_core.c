			     ...
			     struct device_attribute *attr, char *buf)
{
	...
	inv_set_bank(st, BANK_SEL_1);
	bytes_printed += snprintf(buf + bytes_printed, MAX_WR_SZ, "bank 1\n");
	for (ii = 0; ii < 0x2A; ii++) {
		inv_plat_read(st, ii, 1, &data);
		bytes_printed += snprintf(buf + bytes_printed, MAX_WR_SZ,
					"%#2x: %#2x\n", ii, data);
	...
	inv_set_bank(st, BANK_SEL_2);
	bytes_printed += snprintf(buf + bytes_printed, MAX_WR_SZ, "bank 2\n");
	for (ii = 0; ii < 0x55; ii++) {
		inv_plat_read(st, ii, 1, &data);
		bytes_printed += snprintf(buf + bytes_printed, MAX_WR_SZ,
					"%#2x: %#2x\n", ii, data);
	...
	bytes_printed += snprintf(buf + bytes_printed, MAX_WR_SZ, "bank 3\n");
	for (ii = 0; ii < 0x18; ii++) {
		inv_plat_read(st, ii, 1, &data);
		bytes_printed += snprintf(buf + bytes_printed, MAX_WR_SZ,
					"%#2x: %#2x\n", ii, data);
...
static IIO_DEVICE_ATTR(in_magn_wake_enable, S_IRUGO | S_IWUGO,
		       inv_sensor_on_show, inv_sensor_on_store,
		       SENSOR_L_MAG_WAKE);
static IIO_DEVICE_ATTR(in_calib_magn_wake_enable, S_IRUGO | S_IWUGO,
		       inv_sensor_on_show, inv_sensor_on_store,
		       SENSOR_L_MAG_CAL_WAKE);
...
static IIO_DEVICE_ATTR(in_6quat_wake_enable, S_IRUGO | S_IWUGO,
		       inv_sensor_on_show, inv_sensor_on_store,
		       SENSOR_L_SIXQ_WAKE);
static IIO_DEVICE_ATTR(in_9quat_enable, S_IRUGO | S_IWUGO, inv_sensor_on_show,
		       inv_sensor_on_store, SENSOR_L_NINEQ);
static IIO_DEVICE_ATTR(in_9quat_wake_enable, S_IRUGO | S_IWUGO,
		       inv_sensor_on_show, inv_sensor_on_store,
		       SENSOR_L_NINEQ_WAKE);
...
static IIO_DEVICE_ATTR(in_p6quat_wake_enable, S_IRUGO | S_IWUGO,
		       inv_sensor_on_show, inv_sensor_on_store,
		       SENSOR_L_PEDQ_WAKE);
static IIO_DEVICE_ATTR(in_geomag_enable, S_IRUGO | S_IWUGO, inv_sensor_on_show,
		       inv_sensor_on_store, SENSOR_L_GEOMAG);
static IIO_DEVICE_ATTR(in_geomag_wake_enable, S_IRUGO | S_IWUGO,
		       inv_sensor_on_show, inv_sensor_on_store,
		       SENSOR_L_GEOMAG_WAKE);
...
static IIO_DEVICE_ATTR(in_pressure_wake_enable, S_IRUGO | S_IWUGO,
		       inv_sensor_on_show, inv_sensor_on_store,
		       SENSOR_L_PRESSURE_WAKE);
static IIO_DEVICE_ATTR(in_als_px_enable, S_IRUGO | S_IWUGO, inv_sensor_on_show,
...
static IIO_DEVICE_ATTR(in_magn_wake_rate, S_IRUGO | S_IWUGO,
		       inv_sensor_rate_show, inv_sensor_rate_store,
		       SENSOR_L_MAG_WAKE);
static IIO_DEVICE_ATTR(in_calib_magn_wake_rate, S_IRUGO | S_IWUGO,
		       inv_sensor_rate_show, inv_sensor_rate_store,
		       SENSOR_L_MAG_CAL_WAKE);
...
static IIO_DEVICE_ATTR(in_6quat_wake_rate, S_IRUGO | S_IWUGO,
		       inv_sensor_rate_show, inv_sensor_rate_store,
		       SENSOR_L_SIXQ_WAKE);
static IIO_DEVICE_ATTR(in_9quat_rate, S_IRUGO | S_IWUGO, inv_sensor_rate_show,
		       inv_sensor_rate_store, SENSOR_L_NINEQ);
static IIO_DEVICE_ATTR(in_9quat_wake_rate, S_IRUGO | S_IWUGO,
		       inv_sensor_rate_show, inv_sensor_rate_store,
		       SENSOR_L_NINEQ_WAKE);
...
static IIO_DEVICE_ATTR(in_p6quat_wake_rate, S_IRUGO | S_IWUGO,
		       inv_sensor_rate_show, inv_sensor_rate_store,
		       SENSOR_L_PEDQ_WAKE);
static IIO_DEVICE_ATTR(in_geomag_rate, S_IRUGO | S_IWUGO, inv_sensor_rate_show,
		       inv_sensor_rate_store, SENSOR_L_GEOMAG);
static IIO_DEVICE_ATTR(in_geomag_wake_rate, S_IRUGO | S_IWUGO,
		       inv_sensor_rate_show, inv_sensor_rate_store,
		       SENSOR_L_GEOMAG_WAKE);
...
static IIO_DEVICE_ATTR(in_pressure_wake_rate, S_IRUGO | S_IWUGO,
		       inv_sensor_rate_show, inv_sensor_rate_store,
		       SENSOR_L_PRESSURE_WAKE);
static IIO_DEVICE_ATTR(in_als_px_rate, S_IRUGO | S_IWUGO, inv_sensor_rate_show,
...
static IIO_DEVICE_ATTR(info_poke_mode, S_IRUGO | S_IWUGO, inv_attr_show,
...
int inv_check_chip_type(struct iio_dev *indio_dev, const char *name)
{
	...
	if (ICM10340 == st->chip_type || ICM20648 == st->chip_type) {
