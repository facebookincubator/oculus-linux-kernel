...
#define A3D_MODE_PAN		2	/* unknown6 */
#define A3D_MODE_OEM		3	/* unknown6 OEM version */
#define A3D_MODE_PXL		4	/* unknown6 XL */

static char *a3d_names[] = { NULL, "FP-Gaming Assassin 3D", "MadCatz unknown6", "OEM unknown6",
			"MadCatz unknown6 XL", "MadCatz unknown6 XL w/ rudder" };
