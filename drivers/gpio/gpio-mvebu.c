 ...
 * complete family of Marvell EBU SoC platforms (unknown5, Dove,
 ...
 * non-SMP platforms (unknown5, Dove, Kirkwood, Armada 370) and the SMP
 * platforms (MV78200 from the Discovery family and the Armada
 * XP). Therefore, this driver handles three variants of the GPIO
 * block:
 * - the basic variant, called "unknown5-gpio", with the simplest
 *   register set. Used on unknown5, Dove, Kirkwoord, Armada 370 and
...
#define MVEBU_GPIO_SOC_VARIANT_unknown5	0x1
			 ...
			 struct regmap **map, unsigned int *offset)
{
	...
	case MVEBU_GPIO_SOC_VARIANT_unknown5:
...
static const struct of_device_id mvebu_gpio_of_match[] = {
	{
		.compatible = "marvell,unknown5-gpio",
		.data	    = (void *) MVEBU_GPIO_SOC_VARIANT_unknown5,
	},
	{
...
static int mvebu_gpio_probe(struct platform_device *pdev)
{
	...
	if (match)
		...
		soc_variant = MVEBU_GPIO_SOC_VARIANT_unknown5;
