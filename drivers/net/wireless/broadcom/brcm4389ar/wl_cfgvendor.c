...
#if defined(WL_ANDROID_PRIV_CMD_OVER_NL80211) && defined(OEM_ANDROID)
		if (type == BRCM_ATTR_DRIVER_CMD || type == BRCM_ATTR_STRICT_DRIVER_CMD) {
...
const struct nla_policy brcm_drv_attr_policy[BRCM_ATTR_DRIVER_MAX] = {
	...
	[BRCM_ATTR_STRICT_DRIVER_CMD] = { .type = NLA_NUL_STRING },
...
static const struct  nl80211_vendor_cmd_info wl_vendor_events [] = {
		...
		{ OUI_BRCM, BRCM_VENDOR_EVENT_XRAPI_TIME_SYNC},
		{ OUI_BRCM, BRCM_VENDOR_EVENT_XRAPI_PSMODE},
		{ OUI_BRCM, BRCM_VENDOR_EVENT_PHY_CALIBRATION},
		{ OUI_BRCM, BRCM_VENDOR_EVENT_SCAN},
};
