...
#if defined(DHD_ENABLE_S2MPU) && !defined(CONFIG_SOC_S5E9925)
...
#endif /* defined(DHD_ENABLE_S2MPU) && !defined(CONFIG_SOC_S5E9925) */
...
#if defined(BOARD_HIKEY) || defined(XRAPI_COMMON)
...
#endif /* BOARD_HIKEY || XRAPI_COMMON */
	}
