...
static const char rstr_abuck_volt_sleep[] = "abuck_volt_sleep";
static const char rstr_cbuck_volt_sleep[] = "cbuck_volt_sleep";
...
lhl_reg_set_t lv_sleep_mode_4387_lhl_reg_set_top_off[] =
{
	{LHL_REG_OFF(lhl_top_pwrseq_ctl_adr),
		LHL_TOP_PWRSEQ_SLEEP_ENAB_MASK |
...
lhl_reg_set_t lv_sleep_mode_4389_lhl_reg_set[] =
{
	/* set wl_sleep_en */
	{LHL_REG_OFF(lhl_top_pwrseq_ctl_adr), (1 << 0), (1 << 0)},
...
void
si_set_lv_sleep_mode_lhl_config_4389(si_t *sih)
{
	uint i;
	uint coreidx = si_findcoreidx(sih, GCI_CORE_ID, 0);
