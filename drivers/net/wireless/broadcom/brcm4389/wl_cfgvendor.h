...
enum debug_attributes {
	...
	DEBUG_ATTRIBUTE_RING_DATA = 10,
	DEBUG_ATTRIBUTE_RING_STATUS = 11,
	DEBUG_ATTRIBUTE_RING_NUM = 12,
	DEBUG_ATTRIBUTE_DRIVER_DUMP_LEN = 13,
	DEBUG_ATTRIBUTE_DRIVER_DUMP_DATA = 14,
	DEBUG_ATTRIBUTE_PKT_FATE_NUM = 15,
	DEBUG_ATTRIBUTE_PKT_FATE_DATA = 16,
	DEBUG_ATTRIBUTE_HANG_REASON = 17,
...
enum custom_setting_attributes {
	CUSTOM_SETTING_ATTRIBUTE_DSCP_START,
	CUSTOM_SETTING_ATTRIBUTE_DSCP_END,
	CUSTOM_SETTING_ATTRIBUTE_ACCESS_CATEGORY,
