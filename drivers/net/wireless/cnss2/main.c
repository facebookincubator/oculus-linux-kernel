...
static void cnss_get_board_name(struct cnss_plat_data *plat_priv)
{
if (!of_property_read_string(plat_priv->plat_dev->dev.of_node,
		"qcom,board-name", &plat_priv->board_name))
		cnss_pr_dbg("board name read is %s\n", plat_priv->board_name);
}
#endif
