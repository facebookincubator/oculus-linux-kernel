...
#else
static inline void hzos_ext_cpu_idle_enter(int *state, struct cpuidle_device *dev) {}
static inline void hzos_ext_cpu_idle_exit(int state, struct cpuidle_device *dev) {}
#endif
