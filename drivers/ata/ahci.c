...
static const struct pci_device_id ahci_pci_tbl[] = {
	...
	{ PCI_VDEVICE(INTEL, 0x1e02), board_ahci }, /* unknown6 Point AHCI */
	{ PCI_VDEVICE(INTEL, 0x1e03), board_ahci_mobile }, /* unknown6 M AHCI */
	{ PCI_VDEVICE(INTEL, 0x1e04), board_ahci }, /* unknown6 Point RAID */
	{ PCI_VDEVICE(INTEL, 0x1e05), board_ahci }, /* unknown6 Point RAID */
	{ PCI_VDEVICE(INTEL, 0x1e06), board_ahci }, /* unknown6 Point RAID */
	{ PCI_VDEVICE(INTEL, 0x1e07), board_ahci_mobile }, /* unknown6 M RAID */
	{ PCI_VDEVICE(INTEL, 0x1e0e), board_ahci }, /* unknown6 Point RAID */
