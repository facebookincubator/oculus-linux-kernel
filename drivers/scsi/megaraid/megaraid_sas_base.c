...
static struct pci_device_id megasas_pci_table[] = {
	...
	/* unknown6 */
	{PCI_DEVICE(PCI_VENDOR_ID_LSI_LOGIC, PCI_DEVICE_ID_LSI_unknown6)},
	{PCI_DEVICE(PCI_VENDOR_ID_LSI_LOGIC, PCI_DEVICE_ID_LSI_CRUSADER)},
	{PCI_DEVICE(PCI_VENDOR_ID_LSI_LOGIC, PCI_DEVICE_ID_LSI_HARPOON)},
	{PCI_DEVICE(PCI_VENDOR_ID_LSI_LOGIC, PCI_DEVICE_ID_LSI_TOMCAT)},
	{PCI_DEVICE(PCI_VENDOR_ID_LSI_LOGIC, PCI_DEVICE_ID_LSI_unknown6_4PORT)},
...
static int megasas_slave_configure(struct scsi_device *sdev)
{
	...
	/* Some unknown6 firmware may not have instance->nvme_page_size set.
...
static void megasas_update_ext_vd_details(struct megasas_instance *instance)
{
	...
	if (instance->max_raid_mapsize) {
		unknown6_map_sz = instance->max_raid_mapsize *
						MR_MIN_MAP_SIZE; /* 64k */
		fusion->current_map_sz = unknown6_map_sz;
		fusion->max_map_sz = unknown6_map_sz;
	} else {
...
static int megasas_init_fw(struct megasas_instance *instance)
{
	...
	if (instance->adapter_type >= unknown6_SERIES) {
		scratch_pad_2 =
	...
	if (msix_enable && !msix_disable) {
		...
		if (fusion) {
			if (instance->adapter_type == THUNDERBOLT_SERIES) {
				 ...
				 * For unknown6 series, > 16 MSI-x vectors
				 * supported by FW/HW implies combined
				 * reply queue mode is enabled.
				 */
				switch (instance->adapter_type) {
 ...
 * Description:
 *
 * For unknown6, driver/FW will operate in 63bit DMA addresses.
 *
 * For invader-
...
megasas_set_dma_mask(struct megasas_instance *instance)
{
	...
	pdev = instance->pdev;
	consistent_mask = (instance->adapter_type >= unknown6_SERIES) ?
...
static inline void megasas_set_adapter_type(struct megasas_instance *instance)
{
	if ((instance->pdev->vendor == PCI_VENDOR_ID_DELL) &&
		...
		case PCI_DEVICE_ID_LSI_AERO_10E6:
			...
			break;
		case PCI_DEVICE_ID_LSI_unknown6:
		case PCI_DEVICE_ID_LSI_CRUSADER:
		case PCI_DEVICE_ID_LSI_HARPOON:
		case PCI_DEVICE_ID_LSI_TOMCAT:
		case PCI_DEVICE_ID_LSI_unknown6_4PORT:
		case PCI_DEVICE_ID_LSI_CRUSADER_4PORT:
			instance->adapter_type = unknown6_SERIES;
			break;
