...
#define  unknown5_VEND_0   0x4B

#define  hp_vendor_id_1       0x01	/* MSB */
#define  unknown5_VEND_1   0x10

#define  hp_device_id_0       0x02	/* LSB */
#define  unknown5_DEV_0    0x30

#define  hp_device_id_1       0x03	/* MSB */
#define  unknown5_DEV_1    0x81
...
static int FlashPoint_ProbeHostAdapter(struct sccb_mgr_info *pCardInfo)
{
	...
	if (RD_HARPOON(ioport + hp_vendor_id_0) != unknown5_VEND_0)
		return (int)FAILURE;

	if ((RD_HARPOON(ioport + hp_vendor_id_1) != unknown5_VEND_1))
		return (int)FAILURE;

	if ((RD_HARPOON(ioport + hp_device_id_0) != unknown5_DEV_0))
		return (int)FAILURE;

	if ((RD_HARPOON(ioport + hp_device_id_1) != unknown5_DEV_1))
		return (int)FAILURE;
...
/* For new Harpoon then check for sub_device ID LSB
   ...
   current version of SCCBMgr, else skip this Harpoon
	...
	pCardInfo->si_fw_revision = unknown5_FW_REV;
	temp2 = 0x0000;
	temp3 = 0x0000;
	temp4 = 0x0000;
	temp5 = 0x0000;
