 ...
 * that can be found on the following platform: unknown5, Kirkwood, Armada. This
...
static struct skcipher_alg *unknown5_cipher_algs[] = {
	&mv_cesa_ecb_des_alg,
	&mv_cesa_cbc_des_alg,
...
static struct ahash_alg *unknown5_ahash_algs[] = {
	&mv_md5_alg,
	&mv_sha1_alg,
	&mv_ahmac_md5_alg,
	&mv_ahmac_sha1_alg,
...
static const struct mv_cesa_caps unknown5_caps = {
	.nengines = 1,
	.cipher_algs = unknown5_cipher_algs,
	.ncipher_algs = ARRAY_SIZE(unknown5_cipher_algs),
	.ahash_algs = unknown5_ahash_algs,
	.nahash_algs = ARRAY_SIZE(unknown5_ahash_algs),
	.has_tdma = false,
};
...
static const struct of_device_id mv_cesa_of_match_table[] = {
	{ .compatible = "marvell,unknown5-crypto", .data = &unknown5_caps },
...
{
	const struct mv_cesa_caps *caps = &unknown5_caps;
	const struct mbus_dram_target_info *dram;
