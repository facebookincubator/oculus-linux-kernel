...
#else
/* The platform would perform regular reboot upon any crash, rather
 * than going into download mode.
 */
static void set_dload_mode(int on)
{
	/* Save value for sysfs information. */
	dload_mode_enabled = 0;
}
#endif
