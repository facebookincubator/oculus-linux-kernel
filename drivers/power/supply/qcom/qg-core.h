...
struct qpnp_qg {
	...
	/* platform params */
	u32			debug_batt_id_low;
	u32			debug_batt_id_high;
	...
	/* kfifo buffer for the power data exported to userspace */
	DECLARE_KFIFO(power_fifo, int, POWER_FIFO_SIZE);
};
