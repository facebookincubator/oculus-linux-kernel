...
#define FULL_BATT_SUSPEND_INPUT_VOTER	"FULL_BATT_SUSPEND_INPUT_VOTER"
...
struct smb_charger {
	...
	struct work_struct	full_batt_suspend_input_work;
	...
	struct alarm		full_batt_suspend_input_alarm;
	...
	int			connector_type;
	bool			otg_en;
	bool			suspend_input_on_full_batt;
