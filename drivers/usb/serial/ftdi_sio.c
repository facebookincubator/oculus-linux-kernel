...
static const struct usb_device_id id_table_combined[] = {
	...
	{ USB_DEVICE(FTDI_VID, FTDI_NT_unknown5LXM_PID),
		.driver_info = (kernel_ulong_t)&ftdi_jtag_quirk },
	{ USB_DEVICE(FTDI_VID, FTDI_NT_unknown5LX_PLUS_PID) },
	{ USB_DEVICE(FTDI_VID, FTDI_NT_unknown5_IO_PID) },
	{ USB_DEVICE(FTDI_VID, FTDI_NT_unknown5MX_PID) },
