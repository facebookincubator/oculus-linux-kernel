...
#else
static inline int dwc3_usb_register_panic_hdlr(struct dwc3_msm *mdwc)
{
	return 0;
}
static inline void dwc3_usb_unregister_panic_hdlr(struct dwc3_msm *mdwc)
{ }
#endif
