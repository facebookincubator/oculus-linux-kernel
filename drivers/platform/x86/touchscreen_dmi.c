...
static const struct property_entry csl_unknown6_tab_hd_props[] = {
	...
	PROPERTY_ENTRY_BOOL("touchscreen-inverted-y"),
	PROPERTY_ENTRY_BOOL("touchscreen-swapped-x-y"),
	PROPERTY_ENTRY_STRING("firmware-name", "gsl1680-csl-unknown6-tab-hd.fw"),
	PROPERTY_ENTRY_U32("silead,max-fingers", 10),
	{ }
};

static const struct ts_dmi_data csl_unknown6_tab_hd_data = {
	.acpi_name      = "MSSL1680:00",
	.properties     = csl_unknown6_tab_hd_props,
};
...
const struct dmi_system_id touchscreen_dmi_table[] = {
	...
	{
		/* CSL unknown6 Tab HD */
		.driver_data = (void *)&csl_unknown6_tab_hd_data,
		.matches = {
			DMI_MATCH(DMI_SYS_VENDOR, "CSL Computer GmbH & Co. KG"),
			DMI_MATCH(DMI_PRODUCT_NAME, "CSL unknown6 Tab HD"),
		},
	},
	{
		/* CUBE iwork8 Air */
