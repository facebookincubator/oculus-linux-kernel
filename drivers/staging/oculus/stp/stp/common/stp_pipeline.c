...
static void stp_pl_get_data_size_rel(PL_TYPE *pl, uint32_t rel_head, uint32_t *len)
{
 ...
 */
static void stp_pl_get_data_no_update_rel(PL_TYPE *pl,
                                          uint32_t rel_head,
                                          uint8_t *buffer,
                                          uint32_t size,
                                          uint32_t *new_head)
...
static void stp_pl_get_data_no_update(PL_TYPE *pl,
                                      uint8_t *buffer,
                                      uint32_t size,
                                      uint32_t *new_head)
{
