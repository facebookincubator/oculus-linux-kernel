...
enum calculate_pkt_crc_result {
	...
	STP_CALCULATE_CRC_INVALID_INPUT
};
...
struct stp_channel {
	...
	_Atomic uint32_t pending_tx_notification;
...
/* TODO: T214803586 Add proper docstrings to stp_common.h */
uint16_t
...
/**
 * Process a received packet while the rx channel pipeline is locked
 * @param channel Channel
 * @param buffer Buffer containing the packet
 * @param log Log the packet contents if true
