...
struct stp_controller_transport_table
{
    ...
    int32_t (*send_receive_data)(uint8_t *, uint8_t *, uint32_t);
};
...
{
    int32_t (*wait_write)(uint8_t);
    void (*signal_write)(uint8_t);
    int32_t (*wait_read)(uint8_t);
    void (*signal_read)(uint8_t);
    int32_t (*wait_for_device_ready)(void);
    void (*signal_device_ready)(void);
    void (*set_ready_for_transaction)(bool);
    void (*wait_for_data)(void);
    void (*signal_data)(void);
    int32_t (*wait_fsync)(uint8_t);
    void (*signal_fsync)(uint8_t);
    void (*reset_fsync)(uint8_t);
    int32_t (*wait_open)(uint8_t);
    void (*signal_open)(uint8_t);
};
