 ...
 *
 * ex) echo 06 4A 005E 01 > /sys/devices/platform/rtimd-i2c/rtimd_srd_param
 *
 ...
 *
 * ex) echo 06 4A 005E 01 0x7A > /sys/devices/platform/rtimd-i2c/rtimd_sreg
 ...
 *
 * ex) echo 06 4A 0001 0005 5E > /sys/devices/platform/rtimd-i2c/rtimd_brd_param
