...
Please use the appropriate identifier ("hollywood", "seacliff") in the build instructions below.
...
$KERNEL_SRC_PATH/scripts/kconfig/merge_config.sh \
  -O $OUT_PATH \
  -m $KERNEL_SRC_DIR/arch/arm64/configs/vendor/oculus_kona_defconfig $KERNEL_SRC_DIR/arch/arm64/configs/vendor/oculus_hollywood_defconfig

cp $OUT_PATH/.config $KERNEL_SRC_PATH/arch/arm64/configs/hollywood_defconfig

make -C $KERNEL_SRC_PATH ${MAKE_ENV} hollywood_defconfig
