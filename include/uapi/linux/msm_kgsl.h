...
/* Memory types for Vulkan objects */
...
#define IOCTL_KGSL_ALLOW_UID_HIGH_PRIORITY \
	_IOW(KGSL_IOC_TYPE, 0xC0, struct kgsl_allow_uid_high_priority)
...
#define IOCTL_KGSL_ALLOW_TID_MAXIMUM_PRIORITY \
	_IOW(KGSL_IOC_TYPE, 0xC1, struct kgsl_allow_tid_maximum_priority)
