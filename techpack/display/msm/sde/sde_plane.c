...
static void _sde_plane_map_prop_to_dirty_bits(void)
{
	...
	plane_prop_array[PLANE_PROP_COLOR_FILTER] =
	...
	struct sde_mdss_cfg *catalog, u32 master_plane_id)
{
	...
	msm_property_install_enum(&psde->property_info, "color_filter",
		0x0, 0, e_color_filter, ARRAY_SIZE(e_color_filter),
		PLANE_PROP_COLOR_FILTER);
