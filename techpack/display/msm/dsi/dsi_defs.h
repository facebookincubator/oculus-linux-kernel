 ...
 * @DSI_CMD_SET_POST_ON_PRIMARY            Panel post on, unicast to primary panel
 * @DSI_CMD_SET_POST_ON_SECONDARY          Panel post on, unicast to secondary panel
 * @DSI_CMD_SET_MAX
 */
enum dsi_cmd_set_type {
	...
	DSI_CMD_SET_POST_ON_PRIMARY,
	DSI_CMD_SET_POST_ON_SECONDARY,
	DSI_CMD_SET_MAX
};
