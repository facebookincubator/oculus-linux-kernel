...
#define CAM_IFE_FASTPATH_DEVICE_TYPE (CAM_DEVICE_TYPE_BASE + 15)
#define CAM_ICP_FASTPATH_DEVICE_TYPE (CAM_DEVICE_TYPE_BASE + 16)
...
#define CAM_REQ_MGR_MAX_SESSION_HANDLES   16
