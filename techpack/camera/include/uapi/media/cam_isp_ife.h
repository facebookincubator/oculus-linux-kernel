...
#define CAM_ISP_IFE_LITE_OUT_RES_PREPROCESS_RAW1 (CAM_ISP_IFE_OUT_RES_BASE + 37)
#define CAM_ISP_IFE_LITE_OUT_RES_PREPROCESS_RAW2 (CAM_ISP_IFE_OUT_RES_BASE + 38)
#define CAM_ISP_IFE_OUT_RES_RDI_4                (CAM_ISP_IFE_OUT_RES_BASE + 39)
#define CAM_ISP_IFE_OUT_RES_RDI_5                (CAM_ISP_IFE_OUT_RES_BASE + 40)
#define CAM_ISP_IFE_OUT_RES_VIRTUAL_RDI0         (CAM_ISP_IFE_OUT_RES_BASE + 41)
#define CAM_ISP_IFE_OUT_RES_VIRTUAL_RDI1         (CAM_ISP_IFE_OUT_RES_BASE + 42)
#define CAM_ISP_IFE_OUT_RES_VIRTUAL_RDI2         (CAM_ISP_IFE_OUT_RES_BASE + 43)
#define CAM_ISP_IFE_OUT_RES_VIRTUAL_RDI3         (CAM_ISP_IFE_OUT_RES_BASE + 44)
#define CAM_ISP_IFE_OUT_RES_VIRTUAL_RDI4         (CAM_ISP_IFE_OUT_RES_BASE + 45)
#define CAM_ISP_IFE_OUT_RES_VIRTUAL_RDI5         (CAM_ISP_IFE_OUT_RES_BASE + 46)
