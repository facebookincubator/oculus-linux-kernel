...
enum cam_ife_csid_irq_reg {
	...
	CAM_IFE_CSID_IRQ_AP_MONOTONIC_TIMESTAMP_0,
	CAM_IFE_CSID_IRQ_AP_MONOTONIC_TIMESTAMP_1,
 ...
 * @prev_monotonic_timestamp: Previous frame monotonic timestamp
 */
struct cam_ife_csid_timestamp {
	uint64_t                prev_boot_ts;
	uint64_t                prev_sof_ts;
	uint64_t                prev_monotonic_ts;
};
