 ...
 * @event_data2:       HACK: adding this instead of using event_data to avoid having
 *                     to touch a bunch of qc code. Will revert once they implement
 *                     required change themselves.
 *
 */
struct cam_isp_hw_event_info {
	enum cam_isp_resource_type     res_type;
