...
// Increase CAM_REQ_MGR_WATCHDOG_TIMEOUT to 1200 from 1000
// to avoid timeout causing SOF freeze with 1fps camera mode
#define CAM_REQ_MGR_WATCHDOG_TIMEOUT          1200
