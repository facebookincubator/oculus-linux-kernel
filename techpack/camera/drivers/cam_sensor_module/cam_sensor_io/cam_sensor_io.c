...
static bool camera_is_ap_controlled(struct camera_io_master *io_master_info)
{
	struct cam_sensor_ctrl_t *s_ctrl = container_of(io_master_info,
							struct cam_sensor_ctrl_t,
							io_master_info);
	return s_ctrl->sensordata->oculus_is_ap_controlled;
}
