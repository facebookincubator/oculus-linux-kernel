...
struct csiphy_reg_parms_t csiphy_v1_2_3 = {
	...
	.csiphy_2ph_3ph_config_array_size = 25,
...
struct csiphy_reg_t
csiphy_2ph_3ph_combo_mode_2L_1T_reg[MAX_LANES][MAX_SETTINGS_PER_LANE] = {
	{
		{0x0030, 0x00, 0x0, CSIPHY_DEFAULT_PARAMS},
		{0x0230, 0x00, 0x0, CSIPHY_DEFAULT_PARAMS},
		{0x0568, 0x80, 0x0, CSIPHY_DEFAULT_PARAMS},
		{0x056C, 0x25, 0x0, CSIPHY_DEFAULT_PARAMS},
		{0x055C, 0x46, 0x0, CSIPHY_DEFAULT_PARAMS},
		{0x0504, 0x06, 0x0, CSIPHY_DEFAULT_PARAMS},
		{0x050C, 0x08, 0x0, CSIPHY_SETTLE_CNT_LOWER_BYTE},
		{0x0508, 0x00, 0x0, CSIPHY_SETTLE_CNT_HIGHER_BYTE},
		{0x0514, 0x20, 0x0, CSIPHY_DEFAULT_PARAMS},
		{0x0550, 0x00, 0x0, CSIPHY_DEFAULT_PARAMS},
		{0x0588, 0x00, 0x0, CSIPHY_DEFAULT_PARAMS},
		{0x058C, 0x7F, 0x0, CSIPHY_DEFAULT_PARAMS},
		{0x0590, 0x7F, 0x0, CSIPHY_DEFAULT_PARAMS},
		{0x0518, 0x3E, 0x0, CSIPHY_DEFAULT_PARAMS},
		{0x051C, 0x41, 0x0, CSIPHY_DEFAULT_PARAMS},
		{0x0520, 0x41, 0x0, CSIPHY_DEFAULT_PARAMS},
		{0x0524, 0x7F, 0x0, CSIPHY_DEFAULT_PARAMS},
		{0x0528, 0x00, 0x0, CSIPHY_DEFAULT_PARAMS},
		{0x052C, 0x00, 0x0, CSIPHY_DEFAULT_PARAMS},
		{0x0544, 0xB0, 0x0, CSIPHY_DEFAULT_PARAMS},
		{0x0560, 0x02, 0x0, CSIPHY_DEFAULT_PARAMS},
		{0x05CC, 0x41, 0x0, CSIPHY_DEFAULT_PARAMS},
		{0x0564, 0x33, 0x0, CSIPHY_DEFAULT_PARAMS},
		{0x05DC, 0x50, 0x0, CSIPHY_DEFAULT_PARAMS},
		{0x0800, 0x0A, 0x0, CSIPHY_DEFAULT_PARAMS},
	},
	{
		{0x0B90, 0x08, 0x0, CSIPHY_DEFAULT_PARAMS},
		{0x0B94, 0x08, 0x0, CSIPHY_DEFAULT_PARAMS},
		{0x0B98, 0x1A, 0x0, CSIPHY_DEFAULT_PARAMS},
		{0x0B8C, 0xAF, 0x0, CSIPHY_DEFAULT_PARAMS},
		{0x0B84, 0x20, 0x0, CSIPHY_DEFAULT_PARAMS},
		{0x0B88, 0x05, 0x0, CSIPHY_DEFAULT_PARAMS},
		{0x0B80, 0x61, 0x0, CSIPHY_DEFAULT_PARAMS},
		{0x0BB0, 0x01, 0x0, CSIPHY_DEFAULT_PARAMS},
		{0x0BB4, 0x05, 0x0, CSIPHY_DEFAULT_PARAMS},
		{0x0730, 0x00, 0x0, CSIPHY_DEFAULT_PARAMS},
		{0x0724, 0x00, 0x0, CSIPHY_DEFAULT_PARAMS},
		{0x0728, 0x04, 0x0, CSIPHY_DEFAULT_PARAMS},
		{0x0700, 0x80, 0x0, CSIPHY_DEFAULT_PARAMS},
		{0x070C, 0xFF, 0x0, CSIPHY_DEFAULT_PARAMS},
		{0x0738, 0x1F, 0x0, CSIPHY_DEFAULT_PARAMS},
		{0x072C, 0x01, 0x0, CSIPHY_DEFAULT_PARAMS},
		{0x0734, 0x0F, 0x0, CSIPHY_DEFAULT_PARAMS},
		{0x0710, 0x52, 0x0, CSIPHY_DEFAULT_PARAMS},
		{0x071C, 0x0A, 0x0, CSIPHY_DEFAULT_PARAMS},
		{0x0714, 0x60, 0x0, CSIPHY_DEFAULT_PARAMS},
		{0x073C, 0xB8, 0x0, CSIPHY_DEFAULT_PARAMS},
		{0x0704, 0x0C, 0x0, CSIPHY_DEFAULT_PARAMS},
		{0x0720, 0x00, 0x0, CSIPHY_DEFAULT_PARAMS},
		{0x0708, 0x10, 0x0, CSIPHY_SETTLE_CNT_LOWER_BYTE},
		{0x0800, 0x0A, 0x0, CSIPHY_DEFAULT_PARAMS},
	},
	{
		{0x0024, 0x00, 0x0, CSIPHY_DEFAULT_PARAMS},
		{0x0000, 0x8D, 0x0, CSIPHY_DEFAULT_PARAMS},
		...
		{0x0008, 0x10, 0x0, CSIPHY_SETTLE_CNT_LOWER_BYTE},
		{0x0224, 0x00, 0x0, CSIPHY_DEFAULT_PARAMS},
		{0x0200, 0x8D, 0x0, CSIPHY_DEFAULT_PARAMS},
		{0x0238, 0xFE, 0x0, CSIPHY_DEFAULT_PARAMS},
		{0x022C, 0x01, 0x0, CSIPHY_DEFAULT_PARAMS},
		{0x0234, 0x0F, 0x0, CSIPHY_DEFAULT_PARAMS},
		{0x0210, 0x52, 0x0, CSIPHY_DEFAULT_PARAMS},
		{0x021C, 0x0A, 0x0, CSIPHY_DEFAULT_PARAMS},
		{0x0214, 0x60, 0x0, CSIPHY_DEFAULT_PARAMS},
		{0x023C, 0xB8, 0x0, CSIPHY_DEFAULT_PARAMS},
		{0x0204, 0x0C, 0x0, CSIPHY_DEFAULT_PARAMS},
		{0x0220, 0x00, 0x0, CSIPHY_DEFAULT_PARAMS},
		{0x0208, 0x10, 0x0, CSIPHY_SETTLE_CNT_LOWER_BYTE},
		{0x0800, 0x0A, 0x0, CSIPHY_DEFAULT_PARAMS},
	}
};

/* csi_3ph_1dphy_2p5gbps_2cphy_3p5gsps_mission_mode */
/* change csiphy_2ph_3ph_config_array_size = 31 to use */
struct csiphy_reg_t
	csiphy_2ph_3ph_combo_mode_1L_2T_reg[MAX_LANES][MAX_SETTINGS_PER_LANE] = {
			{
				...
				{ 0x030C, 	 0x08,  0x00, CSIPHY_DEFAULT_PARAMS},
				...
				{ 0x0344, 	 0xB0,  0x00, CSIPHY_DEFAULT_PARAMS},
				...
				{ 0x050C, 	 0x08,  0x00, CSIPHY_DEFAULT_PARAMS},
				{ 0x0508, 	 0x00,  0x00, CSIPHY_DEFAULT_PARAMS},
				{ 0x0514, 	 0x20,  0x00, CSIPHY_DEFAULT_PARAMS},
				{ 0x0800, 	 0x0A,  0x00, CSIPHY_DEFAULT_PARAMS}
			},
			{
				...
				{ 0x0544, 	 0xB0,  0x00, CSIPHY_DEFAULT_PARAMS},
				...
				{ 0x0AB4, 	 0x05,  0x00, CSIPHY_DEFAULT_PARAMS},
			...
			},
			{
				...
				{ 0x0BB4, 	 0x05,  0x00, CSIPHY_DEFAULT_PARAMS},
				...
				{ 0x0708, 	 0x10,  0x00, CSIPHY_DEFAULT_PARAMS},
				...
				{ 0x0008, 	 0x10,  0x00, CSIPHY_DEFAULT_PARAMS},
				{ 0x0800, 	 0x0A,  0x00, CSIPHY_DEFAULT_PARAMS}
			}
};
...
struct
csiphy_reg_t csiphy_3ph_v1_2_3_low_peak_reg[MAX_LANES][MAX_SETTINGS_PER_LANE] = {
	{
		{0x0990, 0x08, 0x00, CSIPHY_DEFAULT_PARAMS},
		{0x0994, 0x08, 0x00, CSIPHY_DEFAULT_PARAMS},
		{0x0998, 0x1A, 0x00, CSIPHY_DEFAULT_PARAMS},
		{0x098C, 0xAF, 0x64, CSIPHY_DEFAULT_PARAMS},
		{0x0168, 0x80, 0x00, CSIPHY_DEFAULT_PARAMS},
		{0x016C, 0x20, 0x00, CSIPHY_DEFAULT_PARAMS},
		{0x015C, 0x46, 0x00, CSIPHY_DEFAULT_PARAMS},
		{0x0104, 0x06, 0x00, CSIPHY_DEFAULT_PARAMS},
		{0x010C, 0x08, 0x00, CSIPHY_SETTLE_CNT_LOWER_BYTE},
		{0x0108, 0x00, 0x00, CSIPHY_SETTLE_CNT_HIGHER_BYTE},
	...
	},
	{
		...
		{0x0A8C, 0xAF, 0x64, CSIPHY_DEFAULT_PARAMS},
		{0x0368, 0x80, 0x00, CSIPHY_DEFAULT_PARAMS},
		{0x036C, 0x20, 0x00, CSIPHY_DEFAULT_PARAMS},
		{0x035C, 0x46, 0x00, CSIPHY_DEFAULT_PARAMS},
		{0x0304, 0x06, 0x00, CSIPHY_DEFAULT_PARAMS},
		{0x030C, 0x08, 0x00, CSIPHY_SETTLE_CNT_LOWER_BYTE},
		{0x0308, 0x00, 0x00, CSIPHY_SETTLE_CNT_HIGHER_BYTE},
	...
	},
	{
		...
		{0x0B8C, 0xAF, 0x64, CSIPHY_DEFAULT_PARAMS},
		{0x0568, 0x80, 0x00, CSIPHY_DEFAULT_PARAMS},
		{0x056C, 0x20, 0x00, CSIPHY_DEFAULT_PARAMS},
		{0x055C, 0x46, 0x00, CSIPHY_DEFAULT_PARAMS},
		{0x0504, 0x06, 0x00, CSIPHY_DEFAULT_PARAMS},
		{0x050C, 0x08, 0x00, CSIPHY_SETTLE_CNT_LOWER_BYTE},
		{0x0508, 0x00, 0x00, CSIPHY_SETTLE_CNT_HIGHER_BYTE},
