...
/*
 * BUS Vote supporing only NONE and NOMINAL
 */
enum bus_vote {
	BUS_VOTE_NONE,
	BUS_VOTE_NOMINAL,
 ...
 * @cam_gpio_alflags:           GPIO flags when sensor is always on mode
 **/
struct cam_soc_gpio_data {
	...
	unsigned long *cam_gpio_aoflags;
};
...
struct cam_hw_soc_info {
	...
	enum bus_vote			bus_vote;
	struct mutex			bus_vote_mutex;
};
