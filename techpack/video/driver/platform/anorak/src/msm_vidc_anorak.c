...
static struct msm_platform_inst_capability instance_cap_data_anorak[] = {
	...
	{PIX_FMTS, ENC|DEC, H264,
		...
		MSM_VIDC_FMT_RGBA8888C | MSM_VIDC_FMT_RGBA8888,
		MSM_VIDC_FMT_NV12C},
	...
	{META_MULTI_VIEW_ID, ENC, HEVC,
		V4L2_MPEG_VIDC_META_DISABLE,
		V4L2_MPEG_VIDC_META_ENABLE | V4L2_MPEG_VIDC_META_TX_INPUT,
		0, V4L2_MPEG_VIDC_META_DISABLE,
		V4L2_CID_MPEG_VIDC_METADATA_VIEW_ID_INFO,
		HFI_PROP_VIEW_ID,
		CAP_FLAG_BITMASK},

	{META_MULTI_VIEW_ID, DEC, HEVC,
		V4L2_MPEG_VIDC_META_DISABLE,
		V4L2_MPEG_VIDC_META_ENABLE | V4L2_MPEG_VIDC_META_RX_OUTPUT |
		V4L2_MPEG_VIDC_META_TX_OUTPUT,
		0, V4L2_MPEG_VIDC_META_DISABLE,
		V4L2_CID_MPEG_VIDC_METADATA_VIEW_ID_INFO,
		HFI_PROP_VIEW_ID,
		CAP_FLAG_BITMASK},
	...
	{META_MULTI_VIEW_PAIR, DEC, HEVC,
		V4L2_MPEG_VIDC_META_DISABLE,
		V4L2_MPEG_VIDC_META_ENABLE | V4L2_MPEG_VIDC_META_TX_OUTPUT,
		0, V4L2_MPEG_VIDC_META_DISABLE,
		V4L2_CID_MPEG_VIDC_METADATA_VIEW_PAIR_INFO,
		HFI_PROP_PAIRED_YUV,
		CAP_FLAG_BITMASK},

	{META_THREE_D_REF_DISP_INFO, ENC, HEVC,
		V4L2_MPEG_VIDC_META_DISABLE,
		V4L2_MPEG_VIDC_META_ENABLE | V4L2_MPEG_VIDC_META_TX_INPUT,
		0, V4L2_MPEG_VIDC_META_DISABLE,
	...
	{META_THREE_D_REF_DISP_INFO, DEC, HEVC,
		V4L2_MPEG_VIDC_META_DISABLE,
		V4L2_MPEG_VIDC_META_ENABLE | V4L2_MPEG_VIDC_META_RX_OUTPUT,
		0, V4L2_MPEG_VIDC_META_DISABLE,
		V4L2_CID_MPEG_VIDC_METADATA_THREE_DIMENSIONAL_REF_DISP_INFO,
