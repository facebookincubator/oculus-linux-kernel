...
static struct msm_platform_inst_capability instance_data_neo[] = {
	...
	{LOSSLESS_FRAME_HEIGHT, ENC, H264|HEVC, 128, 3840, 1, 1080},
	{SECURE_FRAME_HEIGHT, DEC, H264|HEVC|VP9, 96, 3840, 1, 1080},
	{SECURE_FRAME_HEIGHT, ENC, H264|HEVC, 128, 3840, 1, 1080},
	{PIX_FMTS, ENC, H264,
		MSM_VIDC_FMT_NV12,
		MSM_VIDC_FMT_NV12C,
	...
	{SECURE_MBPF, ENC|DEC, H264|HEVC|VP9, 64, 32640, 1, 32640},
	/* ((3840 * 2176) / 256) * 30 fps */
	{MBPS, ENC, CODECS_ALL, 64, 979200, 1, 979200},
	/* ((3840 * 2176) / 256) * 30 fps */
	{MBPS, DEC, CODECS_ALL, 64, 979200, 1, 979200},
	/* ((3840 * 2176) / 256) * 30 fps */
	{POWER_SAVE_MBPS, ENC, CODECS_ALL, 0, 979200, 1, 979200},
