...
static struct msm_platform_core_capability core_data_crow_v1[] = {
	/* {type, value} */
	{ENC_CODECS, H264|HEVC|HEIC},
	{DEC_CODECS, H264|HEVC|VP9|HEIC},
	{MAX_SESSION_COUNT, 16},
...
static struct msm_platform_core_capability core_data_crow_v2[] = {
	/* {type, value} */
	{ENC_CODECS, H264|HEVC|HEIC},
	{DEC_CODECS, H264|HEVC|VP9|HEIC},
	{MAX_SESSION_COUNT, 16},
...
static struct msm_platform_inst_capability instance_cap_data_crow_v1[] = {
	/* {cap, domain, codec,
	 *      min, max, step_or_mask, value,
	 *      v4l2_id,
	 *      hfi_id,
...
static struct msm_platform_inst_cap_dependency instance_cap_dependency_data_crow_v1[] = {
	/* {cap, domain, codec,
	 *      parents,
	 *      children,
	 *      adjust, set}
...
static struct msm_platform_inst_capability instance_cap_data_crow_v2[] = {
	/* {cap, domain, codec,
	 *      min, max, step_or_mask, value,
	 *      v4l2_id,
	 *      hfi_id,
...
static struct msm_platform_inst_cap_dependency instance_cap_dependency_data_crow_v2[] = {
	/* {cap, domain, codec,
	 *      parents,
	 *      children,
	 *      adjust, set}
...
static int msm_vidc_init_data(struct msm_vidc_core *core)
{
	...
	if (platform_data->sku_version == SKU_VERSION_1) {
		...
		platform_data->core_data_size =
				ARRAY_SIZE(core_data_crow_v1);
		platform_data->inst_cap_data = instance_cap_data_crow_v1;
		platform_data->inst_cap_data_size =
				ARRAY_SIZE(instance_cap_data_crow_v1);
		platform_data->inst_cap_dependency_data = instance_cap_dependency_data_crow_v1;
		platform_data->inst_cap_dependency_data_size =
				ARRAY_SIZE(instance_cap_dependency_data_crow_v1);
	} else if (platform_data->sku_version == SKU_VERSION_2) {
		platform_data->core_data = core_data_crow_v2;
		platform_data->core_data_size =
				ARRAY_SIZE(core_data_crow_v2);
		platform_data->inst_cap_data = instance_cap_data_crow_v2;
		platform_data->inst_cap_data_size =
				ARRAY_SIZE(instance_cap_data_crow_v2);
