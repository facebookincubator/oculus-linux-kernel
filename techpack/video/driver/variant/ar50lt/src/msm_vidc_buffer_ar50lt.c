...
static u32 msm_vidc_decoder_comv_size_ar50lt(struct msm_vidc_inst *inst)
{
	u32 size = 0;
...
static u32 msm_vidc_decoder_non_comv_size_ar50lt(struct msm_vidc_inst *inst)
{
	u32 size = 0;
	u32 width, height, num_vpp_pipes;
	struct msm_vidc_core *core;
...
static u32 msm_vidc_decoder_line_size_ar50lt(struct msm_vidc_inst *inst)
{
	struct msm_vidc_core *core;
	u32 size = 0;
...
static u32 msm_vidc_decoder_persist_size_ar50lt(struct msm_vidc_inst *inst)
{
	u32 size = 0;
...
static u32 msm_vidc_encoder_bin_size_ar50lt(struct msm_vidc_inst *inst)
{
	struct msm_vidc_core *core;
	u32 size = 0;
...
static u32 msm_vidc_get_recon_buf_count(struct msm_vidc_inst *inst)
{
	...
	HFI_AR50LT_ENC_RECON_BUF_COUNT(num_buf_recon, n_bframe, ltr_count,
			hp_layers, hb_layers, is_hybrid_hp, hfi_codec);

	return num_buf_recon;
}

static u32 msm_vidc_encoder_comv_size_ar50lt(struct msm_vidc_inst *inst)
{
	u32 size = 0;
...
static u32 msm_vidc_encoder_non_comv_size_ar50lt(struct msm_vidc_inst *inst)
{
	struct msm_vidc_core *core;
	u32 size = 0;
	u32 width, height, num_vpp_pipes;
...
static u32 msm_vidc_encoder_line_size_ar50lt(struct msm_vidc_inst *inst)
{
	struct msm_vidc_core *core;
	u32 size = 0;
...
static u32 msm_vidc_encoder_dpb_size_ar50lt(struct msm_vidc_inst *inst)
{
	u32 size = 0;
...
static u32 msm_vidc_encoder_arp_size_ar50lt(struct msm_vidc_inst *inst)
{
	u32 size = 0;
		...
		enum msm_vidc_buffer_type buffer_type)
{
	...
	static const struct msm_vidc_buf_type_handle dec_buf_type_handle[] = {
		...
		{MSM_VIDC_BUF_BIN,             msm_vidc_decoder_bin_size_ar50lt          },
		{MSM_VIDC_BUF_COMV,            msm_vidc_decoder_comv_size_ar50lt         },
		{MSM_VIDC_BUF_NON_COMV,        msm_vidc_decoder_non_comv_size_ar50lt     },
		{MSM_VIDC_BUF_LINE,            msm_vidc_decoder_line_size_ar50lt         },
		{MSM_VIDC_BUF_PERSIST,         msm_vidc_decoder_persist_size_ar50lt      },
		{MSM_VIDC_BUF_DPB,             msm_vidc_decoder_dpb_size_ar50lt          },
	};
	static const struct msm_vidc_buf_type_handle enc_buf_type_handle[] = {
		...
		{MSM_VIDC_BUF_BIN,             msm_vidc_encoder_bin_size_ar50lt          },
		{MSM_VIDC_BUF_COMV,            msm_vidc_encoder_comv_size_ar50lt         },
		{MSM_VIDC_BUF_NON_COMV,        msm_vidc_encoder_non_comv_size_ar50lt     },
		{MSM_VIDC_BUF_LINE,            msm_vidc_encoder_line_size_ar50lt         },
		{MSM_VIDC_BUF_DPB,             msm_vidc_encoder_dpb_size_ar50lt          },
		{MSM_VIDC_BUF_ARP,             msm_vidc_encoder_arp_size_ar50lt         },
	};
...
static int msm_vidc_input_min_count_ar50lt(struct msm_vidc_inst *inst)
{
	...
	if (is_decode_session(inst)) {
		...
		HFI_AR50LT_ENC_MIN_INPUT_BUF_COUNT(input_min_count,
			total_hb_layer);
	} else {
		...
		enum msm_vidc_buffer_type buffer_type)
{
	...
	case MSM_VIDC_BUF_INPUT_META:
		count = msm_vidc_input_min_count_ar50lt(inst);
		break;
