...
SND_SOC_DAILINK_DEFS(sen_mi2s_rx,
	DAILINK_COMP_ARRAY(COMP_CPU("snd-soc-dummy-dai")),
	DAILINK_COMP_ARRAY(COMP_CODEC("msm-stub-codec.1", "msm-stub-rx"),
		COMP_CODEC("max98388_left_codec", "max98388-aif1"),
		COMP_CODEC("max98388_right_codec", "max98388-aif1"),
		COMP_CODEC("max98388_left_codec_ext", "max98388-aif1"),
		COMP_CODEC("max98388_right_codec_ext", "max98388-aif1")),
	DAILINK_COMP_ARRAY(COMP_PLATFORM("snd-soc-dummy")));
...
SND_SOC_DAILINK_DEFS(sen_tdm_rx_0,
	...
	DAILINK_COMP_ARRAY(COMP_CODEC("msm-stub-codec.1", "msm-stub-rx"),
		COMP_CODEC("max98388_left_codec", "max98388-aif1"),
		COMP_CODEC("max98388_right_codec", "max98388-aif1"),
		COMP_CODEC("max98388_left_woofer_codec", "max98388-aif1"),
		COMP_CODEC("max98388_right_woofer_codec", "max98388-aif1"),
		COMP_CODEC("max98388_left_tweeter_codec", "max98388-aif1"),
		COMP_CODEC("max98388_right_tweeter_codec", "max98388-aif1"),
		COMP_CODEC("max98388_left_codec_ext", "max98388-aif1"),
		COMP_CODEC("max98388_right_codec_ext", "max98388-aif1")),
	DAILINK_COMP_ARRAY(COMP_PLATFORM("snd-soc-dummy")));
