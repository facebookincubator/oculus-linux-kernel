...
static struct snd_soc_dai_link cm710x_pri_mi2s_be_dai_links[] = {
	{
...
static struct snd_soc_dai_link cm7120_pri_mi2s_be_dai_links[] = {
	{
		.name = LPASS_BE_PRI_MI2S_RX,
		.stream_name = "Primary MI2S Playback",
		.cpu_dai_name = "msm-dai-q6-mi2s.0",
...
static struct snd_soc_dai_link *mi2s_codec_dai_links[] = {
	cm710x_pri_mi2s_be_dai_links,
	cm7120_pri_mi2s_be_dai_links,
...
static int add_mi2s_intf_links(struct device *dev, int total_links)
{
	...
	for (i = 0; i < ARRAY_SIZE(mi2s_codec_names); i++) {
		...
		links_added += ARRAY_SIZE(msm_pri_mi2s_be_dai_links);
		break;
	}
