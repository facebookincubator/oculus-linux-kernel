...
#define  HFI_CMD_SESSION_EVA_LSR_CONFIG\
	(HFI_CMD_SESSION_CVP_START + 0x074)
#define  HFI_CMD_SESSION_EVA_LSR_FRAME\
	(HFI_CMD_SESSION_CVP_START + 0x075)
#define  HFI_CMD_SESSION_EVA_LSR_SET_GAINMAP\
	(HFI_CMD_SESSION_CVP_START + 0x076)
#define  HFI_CMD_SESSION_EVA_LSR_SET_MVBUFFER\
	(HFI_CMD_SESSION_CVP_START + 0x077)
#define  HFI_CMD_SESSION_EVA_LSR_GPU_SHARED_BUFFER\
	(HFI_CMD_SESSION_CVP_START + 0x079)
#define  HFI_CMD_SESSION_EVA_LSR_NSP_BUFFER\
	(HFI_CMD_SESSION_CVP_START + 0x082)
#define  HFI_CMD_SESSION_EVA_LSR_SET_DISPLAY_BUFFER\
	(HFI_CMD_SESSION_CVP_START + 0x078)
#define  HFI_MSG_SESSION_EVA_LSR\
	(HFI_MSG_SESSION_CVP_START + 0x048)
#define  HFI_MSG_SESSION_EVA_LSR_SET_GAINMAP\
	(HFI_MSG_SESSION_CVP_START + 0x04B)
#define  HFI_MSG_SESSION_EVA_LSR_SET_MVBUFFER\
	(HFI_MSG_SESSION_CVP_START + 0x04C)
#define  HFI_MSG_SESSION_EVA_LSR_GPU_SHARED_BUF\
	(HFI_MSG_SESSION_CVP_START + 0x04E)
#define  HFI_MSG_SESSION_EVA_LSR_NSP_BUF\
	(HFI_MSG_SESSION_CVP_START + 0x04F)
#define  HFI_MSG_SESSION_EVA_LSR_SET_DISPLAY_BUFFER\
	(HFI_MSG_SESSION_CVP_START + 0x04D)
#endif
...
#define  HFI_MSG_SESSION_CVP_XRA_BLOB\
    (HFI_MSG_SESSION_CVP_START + 0x050)
#define  HFI_MSG_SESSION_CVP_XRA_PATCH\
    (HFI_MSG_SESSION_CVP_START + 0x051)
#define  HFI_MSG_SESSION_CVP_XRA_MATCH\
    (HFI_MSG_SESSION_CVP_START + 0x052)
